...
Uses `class Language_Pack_Maker` to installed via composer to create a directory of zip archives of translation mp/po files and a `language-pack.json` file containing data to pass to GitHub Updater.
